...
var me=Object.getPrototypeOf;var ve=Reflect.get;var tt=(e,t,s)=>ve(me(e),s,t);import{m as b,p as It,q as N,s as Pt,u as C,v as fe,x as _,y as w,z as he,A as $e,B as at,C as E,D as be,E as ge,G as ye,H as xe,I as x,J as Gt,K as Se,L,M as we,N as Bt,O as h,P as Lt,Q as Te,R as ke,S as Ft,T as K,U as rt,V as Ce,W as Nt,X as De,Y as Ae,Z as O,$ as Me,a0 as Oe,a1 as Ie,a2 as Pe,a3 as ut,a4 as Ge,a5 as Be,a6 as Le,a7 as Fe,a8 as Ne,a9 as _t,aa as et,ab as _e,ac as Re,ad as Ve,ae as We,af as Rt}from"./app-CKXNl4xf.js";import{e as Ee,c as Ke,t as kt,A as He,l as dt,D as Ct,x as o,o as Qe,n as q,L as Vt,i as qe}from"./vidstack-rsZGrNIW-BiUwPbUx.js";class ze extends Ke{constructor(t){super(t),this.h=null,this.w=!1,this.$=null,this.w=t.type===kt.ATTRIBUTE||t.type===kt.BOOLEAN_ATTRIBUTE}render(t){return t!==this.h&&(this.disconnected(),this.h=t,this.isConnected&&this.Gl()),this.h?this.x(Pt(this.h)):He}reconnected(){this.Gl()}disconnected(){var t;(t=this.$)==null||t.call(this),this.$=null}Gl(){this.h&&(this.$=C(this.l.bind(this)))}x(t){return this.w?dt(t):t}y(t){this.setValue(this.x(t))}l(){var t;this.y((t=this.h)==null?void 0:t.call(this))}}function i(e){return Ee(ze)(b(e))}class Wt{constructor(t,s){this._m=t,this.La=s,this.elements=new Set,this.Gc=It(this.Ha.bind(this))}connect(){this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0,subtree:!0});N(()=>t.disconnect()),N(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){fe(t)?(s.textContent="",s.append(t)):(Ct(null,s),Ct(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const a=s.getAttribute("data-class");a&&n.classList.add(...a.split(" "))}Ha(t){if(t&&!t.some(a=>a.addedNodes.length))return;let s=!1,n=this._m.flatMap(a=>[...a.querySelectorAll("slot")]);for(const a of n)!a.hasAttribute("name")||this.elements.has(a)||(this.elements.add(a),s=!0);s&&this.La(this.elements)}}let Ue=0,W="data-slot-id";class Et{constructor(t){this._m=t,this.Gc=It(this.Ha.bind(this)),this.slots=new Wt(t,this.Ha.bind(this))}connect(){this.slots.connect(),this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0});N(()=>t.disconnect())}Ha(){for(const t of this._m)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let a=s.getAttribute(W);a||s.setAttribute(W,a=++Ue+"");for(const l of this.slots.elements){if(l.getAttribute("name")!==n||l.getAttribute(W)===a)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,l),l.setAttribute(W,a)}}}}function je({name:e,class:t,state:s,paths:n,viewBox:a="0 0 32 32"}){return o`<svg
  ...
  >
    ${_(n)?Qe(n):i(n)}
  </svg>`}class Ze{constructor(t){this._m=t,this.dn={},this.gn=!1,this.slots=new Wt(t,this.hn.bind(this))}connect(){this.slots.connect()}load(){this.Pf().then(t=>{this.dn=t,this.gn=!0,this.hn()})}*jn(){for(const t of Object.keys(this.dn)){const s=`${t}-icon`;for(const n of this.slots.elements)n.name===s&&(yield{icon:this.dn[t],slot:n})}}hn(){if(this.gn)for(const{icon:t,slot:s}of this.jn())this.slots.assign(t,s)}}class Ye extends Ze{connect(){super.connect();const{player:t}=w();if(!t.el)return;let s,n=new IntersectionObserver(a=>{var l;(l=a[0])!=null&&l.isIntersecting&&(s==null||s(),s=void 0,this.load())});n.observe(t.el),s=N(()=>n.disconnect())}}function st(e){const{style:t}=new Option;return t.color=e,t.color.match(/\((.*?)\)/)[1].replace(/,/g," ")}let Dt=!1,nt=new Set;function Xe(){const{player:e}=w();nt.add(e),N(()=>nt.delete(e)),Dt||(he(()=>{for(const t of $e(at)){const s=at[t],n=be[t],a=`--media-user-${E(t)}`,l=`vds-player:${E(t)}`;C(()=>{var $;const r=s(),c=r===n,m=c?null:Je(e,t,r);for(const v of nt)($=v.el)==null||$.style.setProperty(a,m);c?localStorage.removeItem(l):localStorage.setItem(l,r)})}},null),Dt=!0)}function Je(e,t,s){var n;switch(t){case"fontFamily":const a=s==="capitals"?"small-caps":"";return(n=e.el)==null||n.style.setProperty("--media-user-font-variant",a),es(s);case"fontSize":case"textOpacity":case"textBgOpacity":case"displayBgOpacity":return ts(s);case"textColor":return`rgb(${st(s)} / var(--media-user-text-opacity, 1))`;case"textShadow":return ss(s);case"textBg":return`rgb(${st(s)} / var(--media-user-text-bg-opacity, 1))`;case"displayBg":return`rgb(${st(s)} / var(--media-user-display-bg-opacity, 1))`}}function ts(e){return(parseInt(e)/100).toString()}function es(e){switch(e){case"mono-serif":return'"Courier New", Courier, "Nimbus Mono L", "Cutive Mono", monospace';case"mono-sans":return'"Deja Vu Sans Mono", "Lucida Console", Monaco, Consolas, "PT Mono", monospace';case"pro-sans":return'Roboto, "Arial Unicode Ms", Arial, Helvetica, Verdana, "PT Sans Caption", sans-serif';case"casual":return'"Comic Sans MS", Impact, Handlee, fantasy';case"cursive":return'"Monotype Corsiva", "URW Chancery L", "Apple Chancery", "Dancing Script", cursive';case"capitals":return'"Arial Unicode Ms", Arial, Helvetica, Verdana, "Marcellus SC", sans-serif + font-variant=small-caps';default:return'"Times New Roman", Times, Georgia, Cambria, "PT Serif Caption", serif'}}function ss(e){switch(e){case"drop shadow":return"rgb(34, 34, 34) 1.86389px 1.86389px 2.79583px, rgb(34, 34, 34) 1.86389px 1.86389px 3.72778px, rgb(34, 34, 34) 1.86389px 1.86389px 4.65972px";case"raised":return"rgb(34, 34, 34) 1px 1px, rgb(34, 34, 34) 2px 2px";case"depressed":return"rgb(204, 204, 204) 1px 1px, rgb(34, 34, 34) -1px -1px";case"outline":return"rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px";default:return""}}const Kt=we();function u(){return ge(Kt)}const ns={colorScheme:"system",download:null,customIcons:!1,disableTimeSlider:!1,menuContainer:null,menuGroup:"bottom",noAudioGain:!1,noGestures:!1,noKeyboardAnimations:!1,noModal:!1,noScrubGesture:!1,playbackRates:{min:0,max:2,step:.25},audioGains:{min:0,max:300,step:25},seekStep:10,sliderChaptersMinWidth:325,hideQualityBitrate:!1,smallWhen:!1,thumbnails:null,translations:null,when:!1};var as=Object.defineProperty,is=Object.getOwnPropertyDescriptor,Ht=(e,t,s,n)=>{for(var a=is(t,s),l=e.length-1,r;l>=0;l--)(r=e[l])&&(a=r(t,s,a)||a);return a&&as(t,s,a),a};const yt=class yt extends ye{constructor(){super(...arguments),this.cn=b(()=>{const t=this.$props.when();return this.fn(t)}),this.$m=b(()=>{const t=this.$props.smallWhen();return this.fn(t)})}get isMatch(){return this.cn()}get isSmallLayout(){return this.$m()}onSetup(){this.a=w(),this.setAttributes({"data-match":this.cn,"data-sm":()=>this.$m()?"":null,"data-lg":()=>this.$m()?null:"","data-size":()=>this.$m()?"sm":"lg","data-no-scrub-gesture":this.$props.noScrubGesture}),xe(Kt,{...this.$props,when:this.cn,smallWhen:this.$m,userPrefersAnnouncements:x(!0),userPrefersKeyboardAnimations:x(!0),menuPortal:x(null)})}onAttach(t){Gt(t,this.$props.colorScheme)}fn(t){return t!=="never"&&(Se(t)?t:b(()=>t(this.a.player.state))())}};yt.props=ns;let P=yt;Ht([Bt],P.prototype,"isMatch");Ht([Bt],P.prototype,"isSmallLayout");function Qt(e,t){C(()=>{const{player:s}=w(),n=s.el;return n&&L(n,"data-layout",t()&&e),()=>n==null?void 0:n.removeAttribute("data-layout")})}function S(e,t){var s;return((s=e())==null?void 0:s[t])??t}function ct(){return i(()=>{const{translations:e,userPrefersAnnouncements:t}=u();return t()?o`<media-announcer .translations=${i(e)}></media-announcer>`:null})}function T(e,t=""){return o`<slot
    name=${`${e}-icon`}
    data-class=${`vds-icon vds-${e}-icon${t?` ${t}`:""}`}
  ></slot>`}function R(e){return e.map(t=>T(t))}function d(e,t){return i(()=>S(e,t))}function pt({tooltip:e}){const{translations:t}=u(),{remotePlaybackState:s}=h(),n=i(()=>{const l=S(t,"AirPlay"),r=Lt(s());return`${l} ${r}`}),a=d(t,"AirPlay");return o`
  ...
  `}function qt({tooltip:e}){const{translations:t}=u(),{remotePlaybackState:s}=h(),n=i(()=>{const l=S(t,"Google Cast"),r=Lt(s());return`${l} ${r}`}),a=d(t,"Google Cast");return o`
  ...
  `}function A({label:e,option:t,type:s}){const{player:n}=w(),{translations:a}=u(),l=at[s],r=()=>S(a,e);function c(){Ne(),n.dispatchEvent(new Event("vds-font-change"))}if(t.type==="color"){let v=function(p){l.set(p.target.value),c()};return V({label:i(r),children:o`
        <input
      ...
      `})}const m=us(t.values),$=()=>{var f;const v=l(),p=((f=m.find(g=>g.value===v))==null?void 0:f.label)||"";return S(a,_(p)?p:p())};return o`
  ...
  `}function Ss(){return i(()=>{const{translations:e}=u();return o`
      <media-menu class="vds-accessibility-menu vds-menu">
        ...
        <media-menu-items class="vds-menu-items">
          ${[k({children:[ws(),Ts()]}),k({children:[cs()]})]}
        </media-menu-items>
      </media-menu>
    `})}function ws(){const{userPrefersAnnouncements:e,translations:t}=u(),s="Announcements";return V({label:d(t,s),children:Y({label:s,storageKey:"vds-player::announcements",onChange(n){e.set(n)}})})}function Ts(){return i(()=>{const{translations:e,userPrefersKeyboardAnimations:t,noKeyboardAnimations:s}=u(),{viewType:n}=h();if(b(()=>n()!=="video"||s())())return null;const l="Keyboard Animations";return V({label:d(e,l),children:Y({label:l,defaultChecked:!0,storageKey:"vds-player::keyboard-animations",onChange(r){t.set(r)}})})})}function ks(){return i(()=>{const{noAudioGain:e,translations:t}=u(),{audioTracks:s,canSetAudioGain:n}=h();return b(()=>!(n()&&!e())&&s().length<=1)()?null:o`
  ...
  `}function Fs(){const{remote:e,qualities:t}=w(),{autoQuality:s,canSetQuality:n,qualities:a}=h(),{translations:l}=u(),r="Auto";return b(()=>!n()||a().length<=1)()?null:V({label:d(l,r),children:Y({label:r,checked:s,onChange(m,$){m?e.requestAutoQuality($):e.changeQuality(t.selectedIndex,$)}})})}function Ns(){return i(()=>{const{hideQualityBitrate:e,translations:t}=u(),{canSetQuality:s,qualities:n,quality:a}=h(),l=b(()=>!s()||n().length<=1),r=b(()=>Me(n()));return l()?null:k({label:d(t,"Quality"),value:i(()=>{var p,f;const c=(p=a())==null?void 0:p.height,m=e()?null:(f=a())==null?void 0:f.bitrate,$=m&&m>0?`${(m/1e6).toFixed(2)} Mbps`:null,v=S(t,"Auto");return c?`${c}p${$?` (${$})`:""}`:v}),children:[Z({upIcon:"menu-quality-up",downIcon:"menu-quality-down",children:_s(),isMin:()=>r()[0]===a(),isMax:()=>r().at(-1)===a()}),Fs()]})})}function _s(){const{translations:e}=u(),t=d(e,"Quality");return o`
  ...
  `}function Ws(){return i(()=>{const{live:e,duration:t}=h();return e()?Ut():t()?o`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function ne(){return i(()=>{const{live:e}=h();return e()?Ut():Vs()})}function ae(){return i(()=>{const{textTracks:e}=w(),{title:t,started:s}=h(),n=x(null);return Ft(e,"chapters",n.set),n()&&(s()||!t())?ie():o`<media-title class="vds-chapter-title"></media-title>`})}function ie(){return o`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class oe extends Ye{async Pf(){const t=(await De(async()=>{const{icons:n}=await import("./vidstack-CRlTZX3Z-PBDNdscv.js");return{icons:n}},__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=je({name:n,paths:t[n]});return s}}var M;let Es=(M=class extends P{},M.props={...tt(M,M,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576},M);function Ks(){return[ct(),ft(),o`
    ...
    `]}function Hs(){return i(()=>{let e=x(void 0),t=x(!1),s=w(),{title:n,started:a,currentTime:l,ended:r}=h(),{translations:c}=u(),m=Re(e),$=()=>a()||l()>0;const v=()=>{const g=r()?"Replay":$()?"Continue":"Play";return`${S(c,g)}: ${n()}`};C(()=>{var g;m()&&document.activeElement===document.body&&((g=s.player.el)==null||g.focus())});function p(){const g=e(),y=!!g&&!m()&&g.clientWidth<g.children[0].clientWidth;g&&Ve(g,"vds-marquee",y),t.set(y)}function f(){return o`
